<x-dashboard.dashboard-layout>
    ...
    @if (isset($posts) && count($posts) > 0)
        <div class="my-4 gap-4 flex laptop:justify-between flex-wrap">
            <div>
            ...
            <div class="multiple-selection-btns text-gray-400" x-data="{ show: false }">
                <input type="checkbox" name="bulk_delete" id="bulk_delete" class="hidden" x-model="show">
                <label for="bulk_delete" class="bulk-delete-btn cursor-pointer border  px-4 py-2 rounded">
