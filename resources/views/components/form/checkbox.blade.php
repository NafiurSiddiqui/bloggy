...
@if (isset($checkboxOnly))
    <div class="flex items-center">
        <input type="checkbox" id="{{ $id }}" name={{ $inputName }}
            {{ $attributes->merge(['class' => 'w-5 h-5 text-blue-600 bg-gray-50 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 cursor-pointer']) }}
