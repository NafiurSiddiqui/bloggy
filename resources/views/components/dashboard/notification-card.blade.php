...
<li class="flex text-sm border text-gray-700 bg-slate-100 border-gray-100 items-center p-4 w-[14rem] hover:bg-gray-50 dark:border-zinc-800 dark:bg-darkPage dark:text-zinc-300 dark:hover:bg-darkBlack dark:hover:text-zinc-200"
