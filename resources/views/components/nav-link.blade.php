...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center px-4 py-2 text-sm font-medium leading-5 text-gray-900  border-b-2 dark:border-emerald-600/30 
            dark:text-gray-200 dark:bg-darkNavFooter/30 
            ...
            dark:hover:text-gray-200 hover:dark:bg-darkNavFooter  
            hover:bg-stone-50
