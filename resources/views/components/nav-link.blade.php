...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center px-4 py-2 text-base font-medium leading-5 text-zinc-900  border-b-2 border-emerald-300 dark:border-emerald-600/30 
            ...
            : 'inline-flex items-center px-4 py-2 text-base font-medium leading-5 text-zinc-500 dark:text-zinc-400 hover:text-zinc-800 
